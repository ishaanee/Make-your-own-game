...
function setup() {
		...
		invisibleGround = createSprite(200,680,1800,10);
...
function spawnbird() {
  ...
  function spawnObstacles() {
	if(frameCount % 80 === 0) {
	  var obstacle = createSprite(1300,635,10,40);
